...
import { ClientPostViewModel } from 'src/app/model/ClientsPostViewModel';
...
export class ClientCreateComponent implements OnInit {
  ...
  constructor(private currrencyService:CurrencyService, private toster:ToastrService , private Router:Router) { }
